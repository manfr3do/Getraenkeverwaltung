        ...
        btnVerkauf.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (getraenk4.isSelected()) {
                    Getraenkeverwaltung.getraenk4.verkaufen(tfInt);
                    msgPanel.add(verkaufMessage);
                    verkaufMessage.setText(tfInt + " " + Getraenkeverwaltung.getraenk4.getName() + " wurden verkauft.");
                    System.out.println(verkaufMessage);
                    revalidate();
                }
                if (getraenk5.isSelected()) {
                    Getraenkeverwaltung.getraenk5.verkaufen(tfInt);
                    msgPanel.add(verkaufMessage);
                    verkaufMessage.setText(tfInt + " " + Getraenkeverwaltung.getraenk5.getName() + " wurden verkauft.");
                    System.out.println(verkaufMessage);
                    revalidate();
                }
                if (getraenk6.isSelected()) {
                    Getraenkeverwaltung.getraenk6.verkaufen(tfInt);
                    msgPanel.add(verkaufMessage);
                    verkaufMessage.setText(tfInt + " " + Getraenkeverwaltung.getraenk6.getName() + " wurden verkauft.");
                    System.out.println(verkaufMessage);
                    revalidate();
                }
                if (getraenk7.isSelected()) {
                    Getraenkeverwaltung.getraenk7.verkaufen(tfInt);
                    msgPanel.add(verkaufMessage);
                    verkaufMessage.setText(tfInt + " " + Getraenkeverwaltung.getraenk7.getName() + " wurden verkauft.");
                    System.out.println(verkaufMessage);
                    revalidate();
                }
                if (getraenk8.isSelected()) {
                    Getraenkeverwaltung.getraenk8.verkaufen(tfInt);
                    msgPanel.add(verkaufMessage);
                    verkaufMessage.setText(tfInt + " " + Getraenkeverwaltung.getraenk8.getName() + " wurden verkauft.");
                    System.out.println(verkaufMessage);
                    revalidate();
                }
                if (getraenk9.isSelected()) {
                    Getraenkeverwaltung.getraenk9.verkaufen(tfInt);
                    msgPanel.add(verkaufMessage);
                    verkaufMessage.setText(tfInt + " " + Getraenkeverwaltung.getraenk9.getName() + " wurden verkauft.");
                    System.out.println(verkaufMessage);
                    revalidate();
                }
                if (getraenk10.isSelected()) {
                    Getraenkeverwaltung.getraenk10.verkaufen(tfInt);
                    msgPanel.add(verkaufMessage);
                    verkaufMessage.setText(tfInt + " " + Getraenkeverwaltung.getraenk10.getName() + " wurden verkauft.");
                    System.out.println(verkaufMessage);
                    revalidate();
                }
            }
